...
router.post("/", [checkLogin_1.checkLogin, (0, checkRole_1.checkRole)(1)], DisciplinesController_1.default.create);
// Edit one Discipline
router.put("/:id([0-9]+)", [checkLogin_1.checkLogin, (0, checkRole_1.checkRole)(1)], DisciplinesController_1.default.update);
// Delete one Discipline
router.delete("/:id([0-9]+)", [checkLogin_1.checkLogin, (0, checkRole_1.checkRole)(1)], DisciplinesController_1.default.delete);
