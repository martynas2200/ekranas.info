...
var User = /** @class */ (function () {
    ...
    User.prototype.checkIfUnencryptedPasswordIsValid = function (unencryptedPassword) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, bcrypt.compare(unencryptedPassword, this.password)];
            });
        });
    };
    __decorate([
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function (type) { return School_1.School; }, function (school) { return school.users; }, {
            eager: true
        }),
