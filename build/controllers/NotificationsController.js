...
var NotificationsController = /** @class */ (function () {
    ...
    ;
    NotificationsController.listAll = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var notificationsRepository, notifications, currentDate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, typeorm_1.getRepository(Notification_1.Notification)];
                case 1:
                    notificationsRepository = _a.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, notificationsRepository.find({
                            where: {
                                school: req.session.user.school,
                                deletedAt: typeorm_1.Not(typeorm_1.IsNull())
                            },
                            relations: ["user", "images"]
                        })];
                case 4:
                ...
                case 5: return [4 /*yield*/, notificationsRepository.find({
                        where: [{
                                school: req.session.user.school,
                                date1: typeorm_1.MoreThanOrEqual(currentDate),
                                deletedAt: null
                            }, {
                                school: req.session.user.school,
    ...
    //   }
    // };
    NotificationsController.new = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, typeorm_1.getRepository(Notification_1.Notification)];
                case 1:
                    notificationsRepository = _a.sent();
                    _a.label = 2;
                case 2:
    ...
    NotificationsController.toggleVisibility = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, typeorm_1.getRepository(Notification_1.Notification)];
                case 1:
                    notificationRepository = _a.sent();
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
    ...
    NotificationsController.update = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    NotificationsController.delete = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
