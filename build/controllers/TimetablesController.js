...
var TimetablesController = /** @class */ (function () {
    ...
    TimetablesController.getClasses = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, typeorm_1.getRepository(Timetable_1.Timetable).query('SELECT  `timetable`.`className` FROM `timetable` WHERE `timetable`.`schoolId` = ' + req.session.user.school.id + ' GROUP BY `className`;')];
                case 1:
                    rawRows = _a.sent();
                    classes_1 = [];
    ...
    TimetablesController.create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = req.body.row, disciplineId = _a.disciplineId, lessons = _a.lessons;
                    _b = req.body, weekDay = _b.weekDay, semester = _b.semester;
                    ...
                    return [4 /*yield*/, typeorm_1.getRepository(Discipline_1.Discipline)];
                case 1:
                    disciplinesRepository = _c.sent();
                    _c.label = 2;
                case 2:
                    _c.trys.push([2, 4, , 5]);
                ...
                case 6:
                    _c.trys.push([6, 8, , 9]);
                    return [4 /*yield*/, typeorm_1.getRepository(Timetable_1.Timetable)
                            .createQueryBuilder()
                            .insert()
