...
exports.getScreenByKey = exports.getCurrentSemester = exports.EDateType = exports.LessThanOrEqualDate = exports.LessThanDate = exports.MoreThanOrEqualDate = exports.MoreThanDate = void 0;
...
;
var MoreThanDate = function (date, type) { return (0, typeorm_1.MoreThan)((0, date_fns_1.format)(date, type)); };
exports.MoreThanDate = MoreThanDate;
var MoreThanOrEqualDate = function (date, type) { return (0, typeorm_1.MoreThanOrEqual)((0, date_fns_1.format)(date, type)); };
exports.MoreThanOrEqualDate = MoreThanOrEqualDate;
var LessThanDate = function (date, type) { return (0, typeorm_1.LessThan)((0, date_fns_1.format)(date, type)); };
exports.LessThanDate = LessThanDate;
var LessThanOrEqualDate = function (date, type) { return (0, typeorm_1.LessThanOrEqual)((0, date_fns_1.format)(date, type)); };
exports.LessThanOrEqualDate = LessThanOrEqualDate;
var getCurrentSemester = function (school) {
...
var getScreenByKey = function (clue) { return __awaiter(void 0, void 0, void 0, function () {
    var screenReposity, screen, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, index_1.dataSource.getRepository(Screen_1.Screen)];
            case 1:
        ...
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, exports.getScreenByKey)(clue)];
                case 1:
                    screen = _b.sent();
                    if (!screen) {
                        res.status(401).send({
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, index_1.dataSource.getRepository(School_1.School).save(screen.school)];
                case 3:
                    _b.sent();
                    return [3 /*break*/, 5];
                case 4:
                ...
                case 6:
                    _b.trys.push([6, 8, , 9]);
                    return [4 /*yield*/, index_1.dataSource.getRepository(Time_1.Time).findOneOrFail({
                            where: {
        ...
        return __generator(_a, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    notificationsRepository = index_1.dataSource.getRepository(Notification_1.Notification);
                    ...
                    return [4 /*yield*/, notificationsRepository.find({
                            where: [{
                                    ...
                                    school: screen.school.id,
                                    date1: (0, typeorm_1.LessThanOrEqual)(currentDate),
        ...
        return __generator(_a, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    semester = (0, exports.getCurrentSemester)(screen.school);
                    if (!semester)
