...
var UploadsController = /** @class */ (function () {
    ...
    UploadsController.logoUpload = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    UploadsController.imageUpload = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            newName = image.md5 + path.extname(image.name);
            filesLocation = path.join('img/uploads/', newName);
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                ImagesRepository = typeorm_1.getRepository(Image_1.Image);
                                _a.label = 2;
                            case 2:
                                _a.trys.push([2, 4, , 5]);
