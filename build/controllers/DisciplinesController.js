...
var DisciplinesController = /** @class */ (function () {
    ...
    DisciplinesController.getAll = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, index_1.dataSource.getRepository(Discipline_1.Discipline)];
                case 1:
                    disciplinesRepository = _b.sent();
    ...
    DisciplinesController.create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _b, teacher, room, name, disciplinesRepository, discipline, error_1;
        return __generator(_a, function (_c) {
            switch (_c.label) {
                case 0:
                    _b = req.body, teacher = _b.teacher, room = _b.room, name = _b.name;
                    ...
                    disciplinesRepository = index_1.dataSource.getRepository(Discipline_1.Discipline);
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 3, , 4]);
    ...
    DisciplinesController.update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _b, teacher, room, name, id, disciplinesRepository, Checkdiscipline, error_2, discipline, error_3;
        return __generator(_a, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _b = req.body.discipline, teacher = _b.teacher, room = _b.room, name = _b.name;
